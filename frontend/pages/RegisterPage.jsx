...
import { GraduationCap, Lock, User, Mail, ArrowRight, Loader2, UserCircle, CheckCircle } from 'lucide-react';
                        ...
                        {step === 1 ? (
                            ...
                            >
                                <div className="bg-amber-50 border border-amber-100 p-5 rounded-2xl text-amber-700 text-sm font-medium">
                                    Mã OTP xác thực đã được gửi về email!
                                </div>
                                <input
                                    type="text"
                                    maxLength="6"
